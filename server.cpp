...
vector<string> welcome_messages = {"Hope you bought pizzas :p" , "Feel it like your own backyard :D" , 
									"Let the dance floor breaek tonight :D" , "Feels nice to have a homie around :)"};
...
int main(){
	...
	cout << colors[NUM_COLORS-1]<<"\n\t<--------------WELCOME TO LETS TALK CHAT ROOM-------------------->"<<"\n"<<def_col;
	while(true){
...
void handle_client(int client_socket, int id){
	...
	string welcome_message=string("Welcome ") + string(name)+string(" as the ") + string(""+clients.size()) + (welcome_message[0]);
